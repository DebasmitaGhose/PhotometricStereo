...
dataDir     = fullfile('C:','Users','User','Documents','Umass Amherst', 'Semester 1', 'COMPSCI 670 - Computer Vision','Mini Projects','1','p1_data','data'); % Path to your data directory (rename this to where you download the data)
...
outputDir   = fullfile('C:','Users','User','Documents','Umass Amherst', 'Semester 1', 'COMPSCI 670 - Computer Vision','Mini Projects','1','p1_data','output/photometricStereo');
